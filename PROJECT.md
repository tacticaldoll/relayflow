...
- choose the package, command, or module layout
- add the real Go packages or commands
- make the Python Definition of Done runnable from the module root

Before the first real package exists, Go build, test, vet, and format commands
